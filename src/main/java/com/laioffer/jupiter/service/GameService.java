...
public class GameService {
    private static final String TOKEN = "Bearer r1lsvqunjlzzmet7ymtn8jjr6dnzxw";
    private static final String CLIENT_ID = "0kv4pfeb73iyevfn15ov3nxae79b6l";
    ...
    //generate the correct URL when you call Twitch Game API.
    ...
    //build Search URL that will be used when calling Twitch API. e.g. https://api.twitch.tv/helix/clips?game_id=12924.
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        try {
            // Define the HTTP request, TOKEN and CLIENT_ID are used for
            // user authentication on Twitch backend
    ...
    private List<Game> getGameList(String data){
        ...
        try {
            ...
            //输入data，返回需要的type：Game的array,只留下需要的数据
